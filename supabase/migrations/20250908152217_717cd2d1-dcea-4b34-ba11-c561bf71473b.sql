-- ===================================================
-- PATCH FINAL - Nettoyage des données puis contraintes
-- ===================================================
...
-- 2) Nettoyer TOUTES les anciennes valeurs de statut avant d'ajouter la contrainte
...
-- 3) Maintenant ajouter la contrainte CHECK (elle devrait passer)
