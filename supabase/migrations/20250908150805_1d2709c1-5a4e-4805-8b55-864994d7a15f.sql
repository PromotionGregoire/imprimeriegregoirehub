-- ===================================================
-- PATCH SQL - Corrections ciblées pour realtime et facturation
-- ===================================================
...
-- La fonction generate_order_number() existe déjà
ALTER TABLE orders
  ALTER COLUMN order_number SET DEFAULT generate_order_number();

-- (C) Normaliser les statuts FR - ajouter contrainte CHECK
