-- ===================================================
-- PATCH FINAL - 3 corrections de robustesse
-- ===================================================
...
-- 2) Ajouter contrainte CHECK sur submissions.status de manière safe
-- a) Ajouter en NOT VALID (n'impacte pas les lignes existantes)
...
-- b) Normaliser les anciennes valeurs si elles existent encore
...
-- c) Valider la contrainte une fois les données propres
ALTER TABLE submissions VALIDATE CONSTRAINT chk_submissions_status;